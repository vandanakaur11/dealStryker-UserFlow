...
function SettingScreen({ navigation }) {
    ...
    const headers = {
        authorization: `Token eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYyYmZkYjNhMzZhNDE4MDAwNGFlYjYzZiIsImVtYWlsIjoiZ2ltaXc4Nzg4NUBzaGJpc28uY29tIiwicm9sZSI6ImRlYWxlciIsImV4cCI6MTY2MTkyNjYwNSwiaWF0IjoxNjU2NzQyNjA1fQ.LRuvDp9n0futYjDDMKwOZo5qlrhozQHP2zIWLjCdBq0`,
    };
    async function notifyByChat() {
        const bodyNotify = {
            email: "Usamas@gmail.com",
            type: "chat",
        ...
        try {
            let res = await axios.post(
                `${"https://app.dealstryker.com/api/users/setNotificationsType"}`,
                JSON.stringify({
                    email: "Usamas@gmail.com",
                    type: "chat",
                }),
    ...
    //     };
    //     try {
    //         let res = await axios.post(`${"https://app.dealstryker.com/api/users/setNotificationsType"}`, bodyNotify);
    //         console.log(res);
    //     } catch (err) {
    //         console.log(err);
    //     }
