...
import { View, Text, StyleSheet, ScrollView, FlatList, Pressable, Dimensions, Image, Animated } from "react-native";
        ...
        <View style={styles.container}>
            <View style={styles.yearCont}>
                <Pressable onPress={() => year2020()}>
                    <Text style={carsSelect !== 2020 ? styles.yearWrap1 : styles.yearWrap1Select}>2021</Text>
                </Pressable>
                <Pressable onPress={() => year2021()}>
                    <Text style={carsSelect === 2021 ? styles.yearWrap2 : styles.yearWrap2Select}>2020</Text>
                </Pressable>
            </View>
